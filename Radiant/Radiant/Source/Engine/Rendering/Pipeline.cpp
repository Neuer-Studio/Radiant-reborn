...
namespace Radiant
{
	Common::Memory::Shared<Pipeline> Pipeline::Create(const PipelineSpecification& spec)
	{
		switch (RendererAPI::GetAPI())
		{
			case RenderingAPIType::None:    return nullptr;
			case RenderingAPIType::OpenGL:  return Common::Memory::Shared<OpenGLPipeline>::Create(spec);
		}
