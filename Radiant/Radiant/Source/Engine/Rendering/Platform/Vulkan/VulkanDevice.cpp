...
namespace Radiant
{
    ...
    Common::Memory::Shared<VulkanPhysicalDevice> VulkanPhysicalDevice::Create()
    {
        return Common::Memory::Shared<VulkanPhysicalDevice>::Create();
    }
    ...
    void VulkanPhysicalDevice::CreateDevice()
    {
        ...
        auto isDeviceSuitable = [&deviceProperties, &deviceFeatures]( VkPhysicalDevice device )
    ...
    VulkanDevice::VulkanDevice( Common::Memory::Shared<VulkanPhysicalDevice> physicalDevice )
         : m_PhysicalDevice( physicalDevice )
    {
        CreateDevice();
    }

    Common::Memory::Shared<Radiant::VulkanDevice>
    VulkanDevice::Create( Common::Memory::Shared<VulkanPhysicalDevice> physicalDevice )
    {
        return Common::Memory::Shared<VulkanDevice>::Create( physicalDevice );
    }
