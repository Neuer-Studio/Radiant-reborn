...
namespace Radiant
{
	...
	Common::Memory::Shared<Radiant::Image2D> Image2D::Create(const ImageSpecification& spec)
	{
		switch (RendererAPI::GetAPI())
		{
			case RenderingAPIType::None:    return nullptr;
			case RenderingAPIType::OpenGL:  return Common::Memory::Shared<OpenGLImage2D>::Create(spec);
		}
