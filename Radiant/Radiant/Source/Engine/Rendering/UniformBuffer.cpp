...
namespace Radiant
{
    ...
    Common::Memory::Shared<Radiant::UniformBuffer> UniformBuffer::Create( uint32_t size, uint32_t binding )
    {
        switch ( RendererAPI::GetAPI() )
        {
            ...
            case RenderingAPIType::OpenGL:
                return Common::Memory::Shared<OpenGLUniformBuffer>::Create( size, binding );
        }
