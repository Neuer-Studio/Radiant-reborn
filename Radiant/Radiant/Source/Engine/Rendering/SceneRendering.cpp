...
namespace Radiant
{
    ...
    struct Shadow
    {
        Common::Memory::Shared<Pipeline> ShadowPassPipeline[4];
        Common::Memory::Shared<Material> ShadowMapMaterial;
    ...
    struct DrawCommandRigged
    {
        ...
        Common::Memory::Shared<AnimatedMesh>  Mesh;
    };

    struct DrawCommand
    {
        glm::mat4                          Transform;
        Common::Memory::Shared<StaticMesh> Mesh;
    };
    ...
    struct SceneInfo
    {
        ...
        Common::Memory::Shared<Shader>    DefaultShader;
        ...
        Common::Memory::Shared<Pipeline>  GridPipeline;
        Common::Memory::Shared<Material>  GridMaterial;
        Common::Memory::Shared<Pipeline>  SkyboxPipeline;
        Common::Memory::Shared<Material>  SkyboxMaterial;
        struct LightEnvironment           LightEnvironment;
        Common::Memory::Shared<Texture2D> BRDF_LUT;
        UBLights                          LightUB;
        ...
        Common::Memory::Shared<Scene> ActiveScene;
    ...
    void SceneRendering::Init()
    {
...

        {
            ...
            s_SceneInfo->RenderPassList.SelectedGeomerty.material =
                 Material::Create( pipelineSpecification.Shader );
        }
        ...
        {
            m_UniformBufferInfo = Common::Memory::Shared<UniformBufferInfo>::Create();
    ...
    void SceneRendering::BeginScene( Common::Memory::Shared<Scene> scene, const Camera& camera )
    {
    ...
    void SceneRendering::UpdateEnvTextures( const Common::Memory::Shared<Material>& material )
    {
    ...
    void SceneRendering::UploadMeshMaterials( const Common::Memory::Shared<Material>& material )
    {
    ...
    void SceneRendering::SubmitAnimatedMesh( const Common::Memory::Shared<AnimatedMesh>& mesh,
    ...
    void SceneRendering::SubmitStaticMesh( const Common::Memory::Shared<StaticMesh>& mesh,
                                           const glm::mat4&                          transform )
    {
        RADIANT_VERIFY( s_SceneInfo, "Did you call Init() ?" );
    ...
    Common::Memory::Shared<Radiant::Image2D> SceneRendering::GetFinalPassImage()
    {
        RADIANT_VERIFY( s_SceneInfo, "Did you call Init() ?" );
    ...
    Common::Memory::Shared<Radiant::Image2D> SceneRendering::GetShadowMapPassImage()
    {
        RADIANT_VERIFY( s_SceneInfo, "Did you call Init() ?" );
        return nullptr;
    }
    ...
    void SceneRendering::OnUpdate( Common::Timestep ts )
    {
        RADIANT_VERIFY( s_SceneInfo, "Did you call Init() ?" );
