...
namespace Radiant
{
    ...
    Application::Application( const ApplicationSpecification& specification )
    {
        ...
        Common::WindowSpecification wspec;
        ...
        m_Window = Common::Window::Create( wspec );
    ...
    Application::~Application()
    {
        ...
        struct dummy;
        const auto activeins = Common::Memory::Shared<dummy>::DEBUG_GetLiveObjects();
    ...
    void Application::Run()
    {
        ...
        while ( m_Run )
        {
            ...
            m_Timestep      = Common::Timestep( time - m_LastFrameTime );
    ...
    void Application::ProcessEvents( Common::Event& e )
    {
        ...
        eventManager.Notify<EventWindowClose>(
             [this]( const EventWindowClose& e ) -> bool
             {
                 m_Run = false;
                 return true;
             } );
        ...
        eventManager.Notify<EventWindowResize>(
             [this]( const EventWindowResize& e ) -> bool
             {
