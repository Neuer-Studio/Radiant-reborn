...
namespace Radiant
{
    ...
    public:
        ...
        const Common::UUID GetUUID() const
        {
        ...
        Common::UUID GetSceneUUID()
        {
            return m_Scene->GetUUID();
        }

        std::optional<Common::UUID> GetParentUUID() const
        {
            return GetComponent<RelationshipComponent>().ParentHandle;
        }

        void SetParentUUID(Common::UUID parent )
        {
        ...
        {
            Common::UUID               childId  = child.GetUUID();
            std::vector<Common::UUID>& children = Children();
        ...
        [[nodiscard]] std::optional<Entity> TryGetEntityWithUUID( const Common::UUID& uuid ) const;
