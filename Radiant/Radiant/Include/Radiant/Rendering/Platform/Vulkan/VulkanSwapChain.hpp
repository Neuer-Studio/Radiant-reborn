...
namespace Radiant
{
	class VulkanSwapChain : public Common::Memory::RefCounted
	{
	public:
		...
		VulkanSwapChain(const Common::Memory::Shared<VulkanDevice>& device);
	...
	private:
		...
		Common::Memory::Shared<VulkanDevice> m_LogicalDevice;
