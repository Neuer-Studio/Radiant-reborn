...
namespace Radiant
{
	...
	public:
		...
		virtual bool Loaded() const override { return m_Image2D->IsLoaded(); }

		virtual const Common::Memory::Shared<Image2D>& GetImage2D() const override { return m_Image2D; }
	private:
		std::filesystem::path m_FilePath;
		std::string m_Name;
		bool m_sRGB = false;
		Common::Memory::Shared<Image2D> m_Image2D;
	};
}