...
namespace Radiant
{
	...
	public:
		...
		virtual Common::Memory::Shared<Image2D> GetColorAttachmentImage(uint32_t index) const override { return m_ColorAttachments[index]; }
		virtual Common::Memory::Shared<Image2D> GetDepthAttachmentImage() const override { return m_DepthAttachment; }
	private:
		std::optional<RenderingID> m_RenderingID;
		FramebufferSpecification m_Specification;

		std::vector<Common::Memory::Shared<Image2D>> m_ColorAttachments;
		Common::Memory::Shared<Image2D> m_DepthAttachment;
