...
namespace Radiant
{
    ...
    class VertexBuffer : public Common::Memory::RefCounted
    {
    public:
        ...
        static Common::Memory::Shared<VertexBuffer> Create( void* data, uint32_t size,
                                                    OpenGLBufferUsage usage = OpenGLBufferUsage::Static );
        static Common::Memory::Shared<VertexBuffer> Create( uint32_t          size,
