...
#include <Radiant/Assets/Asset.hpp>
...
namespace Radiant
{
    ...
    class Mesh REGESTRY_AS_ASSET
    {
    protected:
        Mesh( const std::filesystem::path& filepath );

    public:
        REGESTRY_ASSET_TYPE(Mesh);
    ...
    protected:
        ...
        Common::Memory::Shared<VertexBuffer>      m_VertexBuffer;

    private:
        glm::mat4                   m_GlobalInverseTransform;
        std::vector<Submesh>        m_Submeshes;
        Common::Memory::Shared<IndexBuffer> m_IndexBuffer;
        Common::Memory::Shared<Material>    m_Material;
        Common::Memory::Shared<Shader>      m_MeshShader;
