            ...
            switch ( type )
            {
                case RadiantShaderType::Vertex:
                    return Constants::Path::RESOURCE_SPIRV_BINARY /
                           ( shaderFile.stem().string() + Constants::Extensions::SPIRV_BINARY_EXTENSION_VERT );
                case RadiantShaderType::Fragment:
                    return Constants::Path::RESOURCE_SPIRV_BINARY /
                           ( shaderFile.stem().string() + Constants::Extensions::SPIRV_BINARY_EXTENSION_FRAG );
                case RadiantShaderType::Compute:
                    return Constants::Path::RESOURCE_SPIRV_BINARY /
                           ( shaderFile.stem().string() + Constants::Extensions::SPIRV_BINARY_EXTENSION_COMP );
            }
