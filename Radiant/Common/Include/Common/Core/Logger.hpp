...
#define RA_INFO( ... )  Common::Logger::LogInfo( __VA_ARGS__ );
#define RA_WARN( ... )  Common::Logger::LogWarn( __VA_ARGS__ );
#define RA_ERROR( ... ) Common::Logger::LogError( __VA_ARGS__ );
#define RA_TRACE( ... ) Common::Logger::LogTrace( __VA_ARGS__ );
#define RA_DEBUG( ... ) Common::Logger::LogDebug( __VA_ARGS__ );
